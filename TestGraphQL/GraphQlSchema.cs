...
namespace TestGraphQL
{
    public class GraphQlSchema
    {
        ...
        public GraphQlSchema()
        {
            ...
            //var ms = GraphQLSchemaObj.AddType<Manuscript>();
            //ms.AddField(u => u.ManuscriptId); 
            ...
            GraphQLSchemaObj.AddListField("Manuscripts", new { last = 0 },(db, arg) => GetManuscripts(db,arg.last));
    ...
    //(db, args, user) => user);
        ...
        {
            return db.Manuscripts.OrderBy(i => i.ManuscriptId).Take(last).AsQueryable();
